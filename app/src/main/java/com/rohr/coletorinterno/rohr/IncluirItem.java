...
public class IncluirItem extends AppCompatActivity implements View.OnClickListener{
...
//    EditText descInutilizado;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView placa = (TextView)findViewById(R.id.PlacaVeiculo);
...
//        descInutilizado = (EditText)findViewById(R.id.descInutilizado);
    ...
    public void onClick(View v) {
        ...
        Intent itemAlterado = new Intent(this, DescargaItens.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_incluiritem, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()){
            case android.R.id.home:
                ...
                AlertDialog.Builder alertDialog = new AlertDialog.Builder(IncluirItem.this);
                ...
                alertDialog.setPositiveButton("Sim", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Intent intent = new Intent(IncluirItem.this, DescargaItens.class);
                        startActivity(intent);

                        Toast.makeText(getApplicationContext(),"Não tem novo item!", Toast.LENGTH_LONG).show();
                ...
                alertDialog.setNegativeButton("Não", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        Toast.makeText(getApplicationContext(),"Ok, inclua o novo item.", Toast.LENGTH_SHORT).show();
                        dialog.cancel();
                    }
                });
                alertDialog.show();
