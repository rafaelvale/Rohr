...
public class DescargaItens extends AppCompatActivity {
    ...
    TextView FirstName;
      ...
      protected void onCreate(Bundle savedInstanceState) {
          ...
          qtdeDescarga = (TextView) findViewById(R.id.qtdeDescarga);
...
//
          ...
          btnConfirmaDescarga.setOnClickListener(new View.OnClickListener() {
              ...
              public void onClick(View v) {
                  ...
                  Toast.makeText(getApplicationContext(), "Item Conferido na Descarga", Toast.LENGTH_SHORT).show();
              }
          });
...
//        ListViewDescarga.setAdapter(adapter);
    ...
    private static final String[] ITEMS = new String[]{
            "FFAGEV30 - ANGULO EXTERNO VARIAVEL L= 300 - FFA","FFALINES - ALINHADOR ESTRIBO - FFA", "FFCANPIL - CANTONEIRA FIXA P/ PILAR - FFA",
            "FFCUNPIN - CUNHA P/ PINO - FFA", "FFAGEV30 - ANGULO EXTERNO VARIAVEL L= 300 - FFA", "FFESC2-4 - ESCORA H= 2,5 - 4,5 M - FFA",
            "FFAGEV30 - ANGULO EXTERNO VARIAVEL L= 300 - FFA", "FFESC4-6 - ESCORA H= 4 - 6.5 M - FFA", "FFGRAUNI - GRAMPO UNIVERSAL - FFA",
            "FFMONAND - MONTANTE P/ ANDAIME DE TRABALHO - FFA", "FFAGEV30 - ANGULO EXTERNO VARIAVEL L= 300 - FFA", "FFP15030 - PAINEL MANUAL DE 150 X 30 CM - FFA",
            "FFP15055 - PAINEL MANUAL DE 150 X 55 CM - FFA", "FFP15070 - PAINEL MANUAL DE 150 X 70 CM - FFA", "FFP15080 - PAINEL MANUAL DE 150 X 80 CM - FFA",
            "FFP15090 - PAINEL MANUAL DE 150 X 90 CM - FFA", "FFP15120 - PAINEL MANUAL DE 150 X 120 CM - FFA"
    };
    @Override
